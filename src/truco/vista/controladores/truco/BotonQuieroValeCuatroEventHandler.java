...
public class BotonQuieroValeCuatroEventHandler implements EventHandler<ActionEvent> {
    ...
    public BotonQuieroValeCuatroEventHandler(Truco juego, VBox contenedorDeEstados, VBox contenedorDeCartas, VBox contenedorDePuntos, VBox contenedorVertical) {
