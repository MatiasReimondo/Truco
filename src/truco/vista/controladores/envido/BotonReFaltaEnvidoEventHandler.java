...
public class BotonReFaltaEnvidoEventHandler implements EventHandler<ActionEvent> {
    ...
    public BotonReFaltaEnvidoEventHandler(Truco juego, VBox contenedorDeEstados, VBox contenedorDeCartas){
