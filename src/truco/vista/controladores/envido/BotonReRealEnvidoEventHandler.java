...
public class BotonReRealEnvidoEventHandler implements EventHandler<ActionEvent> {
    ...
    public BotonReRealEnvidoEventHandler(Truco juego, VBox contenedorDeEstados, VBox contenedorDeCartas, VBox contenedorDePuntos, VBox contenedorVertical){
