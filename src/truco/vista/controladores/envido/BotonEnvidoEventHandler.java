...
public class BotonEnvidoEventHandler implements EventHandler<ActionEvent> {
    ...
    private void graficarContenedorDeEstados(){
        ...
        BotonEnvidoEnvidoEventHandler botonEnvidoEnvidoEventHandler = new BotonEnvidoEnvidoEventHandler(this.juego,this.contenedorDeEstados, this.contenedorDeCartas);
        botonEnvidoEnvido.setOnAction(botonEnvidoEnvidoEventHandler);


        Button botonReRealEnvido = new Button("REAL ENVIDO");
        BotonReRealEnvidoEventHandler botonReRealEnvidoEventHandler = new BotonReRealEnvidoEventHandler(this.juego,this.contenedorDeEstados, this.contenedorDeCartas);
